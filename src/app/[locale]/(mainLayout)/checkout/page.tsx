                ...
                <div className="lg:w-3/5 space-y-8">
                    ...
                    <div className="bg-surface border border-border rounded-lg p-6">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <LocaleLink href="/sign-in" className="text-sm text-primary hover:underline font-medium">Already have an account? Login</LocaleLink>
                        </div>
                    ...
                    <div className="bg-surface border border-border rounded-lg p-6 sticky top-[130px]">
                        ...
                        <label className="flex items-start gap-2 mb-6 cursor-pointer">
                            ...
                            <span className="text-xs text-text-secondary leading-snug">
                                I agree to the <LocaleLink href="/terms" className="text-primary hover:underline">Terms & Conditions</LocaleLink> and <LocaleLink href="/privacy" className="text-primary hover:underline">Privacy Policy</LocaleLink>.
                            </span>
                        </label>

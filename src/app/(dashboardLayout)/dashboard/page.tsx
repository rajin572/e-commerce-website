                    ...
                    <table className="w-full text-left text-sm whitespace-nowrap">
                        ...
                        <tbody className="divide-y divide-border">
                            <tr>
                                ...
                                <td className="p-4">
                                    <Link href="/track-order" className="text-primary hover:underline font-medium">Track</Link>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td className="p-4">
                                    <Link href="/dashboard/orders" className="text-primary hover:underline font-medium">View</Link>
                                </td>
                            </tr>
                        </tbody>
                    </table>

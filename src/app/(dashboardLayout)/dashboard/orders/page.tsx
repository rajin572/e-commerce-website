                            ...
                            {[1, 2, 3, 4, 5].map((item) => (
                                <tr key={item} className="hover:bg-muted/50 transition-colors">
                                    ...
                                    <td className="p-4 text-right">
                                        <Link href="/track-order" className="text-primary hover:underline font-medium px-3 py-1.5 border border-primary/20 rounded-md hover:bg-primary/5 transition-colors">
                                            View Details
                                        </Link>
                                    </td>
                                </tr>

                    ...
                    <div className="bg-surface border border-border rounded-lg overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 p-4 border-b border-border items-center">
                            <div className="col-span-1 md:col-span-3 flex gap-4">
                                ...
                                <div className="flex flex-col justify-center">
                                    <Link href="/product/sundarban-honey-premium" className="text-sm md:text-base font-semibold hover:text-primary transition-colors line-clamp-2 mb-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 p-4 border-b border-border items-center">
                            <div className="col-span-1 md:col-span-3 flex gap-4">
                                ...
                                <div className="flex flex-col justify-center">
                                    <Link href="/product/pure-gawa-ghee" className="text-sm md:text-base font-semibold hover:text-primary transition-colors line-clamp-2 mb-1">
